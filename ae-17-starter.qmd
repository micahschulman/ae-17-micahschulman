...
-   Its creating variables `credit_util`, `bankruptcy`, and `homeownership`, then renaming `credit_checks` and selecting some of the variables.
...
-   Influence - How much a point changes the line of best fit
...
Holding bill length constant, for a one mm increase in flipper length, we expect on average a 48.1 increase in body mass.
